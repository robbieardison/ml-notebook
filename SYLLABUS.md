# Syllabus: classical ML course

Work through modules in order. Each folder has a short `README.md` with objectives.
...
- [course/04-feature-engineering-and-pipelines/04-sklearn-pipelines.ipynb](course/04-feature-engineering-and-pipelines/04-sklearn-pipelines.ipynb)
- [course/04-feature-engineering-and-pipelines/credit-risk-prediction-training-and-eda.ipynb](course/04-feature-engineering-and-pipelines/credit-risk-prediction-training-and-eda.ipynb)
- Exercise: [exercises/module-04-pipelines.md](exercises/module-04-pipelines.md)
...
- [course/06-ensembles-and-boosting/kickstarter_campaign_prediction.ipynb](course/06-ensembles-and-boosting/kickstarter_campaign_prediction.ipynb)
- [course/06-ensembles-and-boosting/06-boosting-xgboost-lightgbm.ipynb](course/06-ensembles-and-boosting/06-boosting-xgboost-lightgbm.ipynb)
- Exercise: [exercises/module-06-ensembles.md](exercises/module-06-ensembles.md)

## Module 7 – Time series (baselines)

- [course/07-time-series-and-forecasting-basics/07-baseline-forecasting.ipynb](course/07-time-series-and-forecasting-basics/07-baseline-forecasting.ipynb)
- Exercise: [exercises/module-07-time-series.md](exercises/module-07-time-series.md)
...
Older or out-of-scope notebooks live under [legacy/](legacy/README.md).
